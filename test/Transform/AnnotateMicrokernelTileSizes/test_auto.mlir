// RUN: aten-opt %s -annotate-microkernel-tile-sizes -split-input-file | FileCheck %s

// CHECK: [[CONFIG_FILL:.+]] = #xten_nn.lowering_config<tile_sizes = {{\[\[}}256, 128]]>
// CHECK: [[CONFIG_MATMUL:.+]] = #xten_nn.lowering_config<tile_sizes = {{\[\[}}256, 128], [256, 128], [256, 128]]>

// CHECK-LABEL: forward
// CHECK: linalg.fill {lowering_config = [[CONFIG_FILL]]}
// CHECK: linalg.matmul {lowering_config = [[CONFIG_MATMUL]]}
